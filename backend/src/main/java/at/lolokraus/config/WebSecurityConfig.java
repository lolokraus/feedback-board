package at.lolokraus.config;

import at.lolokraus.security.auth.*;
import at.lolokraus.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().ignoringAntMatchers("/api/login", "/api/signup", "/api/feedback/*" )
